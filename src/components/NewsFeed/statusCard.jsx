export default function StatusCard() {
  return (
    ...
    <div className="p-6 rounded-lg shadow-lg bg-gray-50 mt-6">
      ...
      <div className="p-6">
        {/* <h5 className="text-gray-900 text-xl font-medium mb-2">Status 1</h5> */}
      ...
      <form>
        <div className="flex items-center py-2 px-3 rounded-lg dark:bg-gray-700">
    ...
    <div className="p-6 rounded-lg shadow-lg bg-gray-50 mt-6">
      <a href="#!">
        <img className="rounded-t-lg" src="https://mdbootstrap.com/img/new/standard/nature/122.jpg" alt="" />
      </a>
    ...
    <div className="p-6 rounded-lg shadow-lg bg-gray-50 mt-6">
      <a href="#!">
        <img className="rounded-t-lg" src="https://mdbootstrap.com/img/new/standard/nature/123.jpg" alt="" />
      </a>
    ...
    <div className="p-6 rounded-lg shadow-lg bg-gray-50 mt-6">
      <a href="#!">
        <img className="rounded-t-lg" src="https://mdbootstrap.com/img/new/standard/nature/124.jpg" alt="" />
      </a>
    ...
    <div className="p-6 rounded-lg shadow-lg bg-gray-50 mt-6">
      <a href="#!">
        <img className="rounded-t-lg" src="https://mdbootstrap.com/img/new/standard/nature/125.jpg" alt="" />
      </a>
    ...
    <div className="p-6 rounded-lg shadow-lg bg-gray-50 mt-6">
      <a href="#!">
        <img className="rounded-t-lg" src="https://mdbootstrap.com/img/new/standard/nature/126.jpg" alt="" />
      </a>
